...
import { fetchDataWithPagination, updateData } from "../API/api";
        ...
        {data?.map((elem) => {
          ...
          return (
            <div key={id}>
              ...
              <button className="px-5 py-2 bg-red-500 text-white text-md rounded cursor-pointer" onClick={()=>updateMutation.mutate(id)}>Update</button>
            </div>
          );
        })}
      </div>
